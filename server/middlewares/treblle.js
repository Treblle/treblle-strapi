const { sendPayloadToTreblle, generateFieldsToMask, maskSensitiveValues, getRequestDuration } = require('@treblle/utils')
const os = require('os')
const { version: sdkVersion } = require('../../package.json')

module.exports = (config, { strapi }) => {
  return async (ctx, next) => {
    const { apiKey, projectId, routesToIgnore, additionalFieldsToMask } = strapi.config.get('plugin.treblle')
